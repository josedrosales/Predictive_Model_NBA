...
players = pd.read_csv(r'C:\Users\sebas\Documents\Proyecto_DS\ProyectoDS\data\raw\data_complete_raw.csv', dtype={'PLAYER_ID': int})
players_records = players.to_records(index=False)
print(players_records.dtype )
